      ...
      <Container>
        ...
        <div className="text-white mt-4 mb-2">
          <div className="my-1 flex justify-between items-center">
            {/* Left */}
            <div
              className={`	bg-green-500  px-8 2xl:pl-4 2xl:pr-14 2xl:py-[0.50rem] py-[0.30rem] relative overflow-hidden flex items-center`}
            >
          ...
          <div className={`	bg-green-500 h-1 md:h-2 w-full`}></div>
        </div>
